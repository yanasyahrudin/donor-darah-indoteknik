                ...
                <tbody>
                    @forelse($participants as $p)
                        ...
                        <tr class="border-b hover:bg-blue-50 transition">
                            ...
                            <td class="p-3">
                                <span class="bg-red-100 text-red-600 px-2 py-1 rounded text-xs font-medium">{{ $p->keterangan }}</span>
                            </td>
                        </tr>
                    @empty
                        <tr>
        ...
        <div class="bg-white rounded-2xl shadow-xl p-6 w-11/12 max-w-md relative">
            ...
            <form method="POST" action="{{ route('admin.storeParticipant') }}" class="space-y-4">
                ...
                <div>
                    ...
                    <input name="keterangan" rows="3" class="w-full border rounded-lg px-3 py-2 focus:ring focus:ring-blue-200" placeholder="Isi status peserta (VIP / Bukan VIP)">
                </div>
